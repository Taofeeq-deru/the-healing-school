...
(function (global, factory) {
  ...
  var DEFAULTS = {
    ...
    minCanvasHeight: 0,
    minCropBoxWidth: 224,
    minCropBoxHeight: 223,
    minContainerWidth: 224,
    minContainerHeight: 223,
  ...
  var IS_SAFARI_OR_UIWEBVIEW =
    navigator &&
    /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(navigator.userAgent);
  ...
  var render = {
    ...
    limitCropBox: function limitCropBox(isSizeLimited, isPositionLimited) {
      ...
      if (isSizeLimited) {
        ...
        var maxCropBoxWidth = Math.min(
          container.width,
          limited ? canvas.width : container.width
        );
        var maxCropBoxHeight = Math.min(
          container.height,
          limited ? canvas.height : container.height
        );
      ...
      if (isPositionLimited) {
        if (limited) {
          ...
          cropBox.maxLeft =
            Math.min(container.width, canvas.left + canvas.width) -
            cropBox.width;
          cropBox.maxTop =
            Math.min(container.height, canvas.top + canvas.height) -
            cropBox.height;
        } else {
          cropBox.minLeft = 0;
          cropBox.minTop = 0;
    ...
    renderCropBox: function renderCropBox() {
      ...
      if (options.movable && options.cropBoxMovable) {
        ...
        this.$face.data(
          DATA_ACTION,
          cropBox.width >= container.width && cropBox.height >= container.height
            ? ACTION_MOVE
            : ACTION_ALL
        );
      }
  ...
  var handlers = {
    resize: function resize() {
      ...
      if (
        this.disabled ||
        container.width <= minContainerWidth ||
    ...
    cropStart: function cropStart(e) {
      ...
      if (originalEvent && originalEvent.changedTouches) {
        ...
        pointers[(originalEvent && originalEvent.pointerId) || 0] = getPointer(
          originalEvent || e
        );
      }
      ...
      [
        ...
        },
        {
          ...
          value: function load(url) {
            ...
            xhr.withCredentials =
              $element.prop("crossOrigin") === "use-credentials";
            xhr.send();
          },
        },
        {
        ...
        },
        {
          ...
          value: function start() {
            ...
            getImageNaturalSizes($image[0], function (
              naturalWidth,
              naturalHeight
            ) {
              $.extend(_this2.image, {
        ...
        },
        {
          ...
          value: function build() {
            ...
            if (!options.cropBoxResizable) {
              $cropBox
                .find("." + NAMESPACE + "-line,." + NAMESPACE + "-point")
